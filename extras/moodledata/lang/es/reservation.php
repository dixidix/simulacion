...
/**
 * Strings for component 'reservation', language 'es', branch 'MOODLE_26_STABLE'
 *
 * @package   reservation
...
$string['clashesfound'] = 'Se encontraron algunas incompatibilidades de hora y lugar';
...
$string['completionreserved'] = 'Se debe hacer una reserva para completar la actividad';
...
$string['configconnectto'] = 'Especifique donde busca el módulo las reservas a las que conectarse';
...
$string['configevents'] = 'Este ajuste define los eventos que serán creados para cada reserva';
