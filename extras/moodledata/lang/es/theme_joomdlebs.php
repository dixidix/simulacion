...
/**
 * Strings for component 'theme_joomdlebs', language 'es', branch 'MOODLE_26_STABLE'
 *
...
$string['fontnamedesc'] = 'Google Fonts usada como fuente principal en la plantilla de Joomla. Dejar en blanco para usar la fuente por defecto.';
