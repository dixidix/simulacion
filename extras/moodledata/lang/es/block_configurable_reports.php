...
$string['coursecategories'] = 'Filtro de categorías del curso';
...
$string['cron'] = 'Ejecución automática diaria';
...
$string['crrepository'] = 'Repositorio de informes';
...
$string['displayglobalreports'] = 'Mostrar informes globales';
...
$string['enableglobal'] = 'Este es un informe global (accesible desde cualquier curso)';
...
$string['filtercoursecategories'] = 'Filtrar por categoría de curso';
...
$string['filtersubcategories'] = 'Categoría (Incluyendo sub-categorías)';
$string['filtersubcategories_summary'] = 'Uso: %%FILTER_CATEGORIES:mdl_course_category.path%%';
$string['filteruser'] = 'Usuario actual del curso';
$string['filterusers'] = 'Usuario de sistema';
...
$string['lastexecutiontime'] = 'Tiempo de ejecución = {$a} (seg)';
...
$string['queryfailed'] = 'Falló la consulta';
...
$string['totalrecords'] = 'Recuento total de registros = {$a->totalrecords}';
